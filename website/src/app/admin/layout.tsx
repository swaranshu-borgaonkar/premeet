...
const navItems = [
  ...
  { label: 'Workspaces', href: '/admin/workspaces', icon: WorkspacesIcon },
  { label: 'Email Config', href: '/admin/email', icon: EmailIcon },
  { label: 'Security', href: '/admin/security', icon: SecurityIcon },
  { label: 'Billing', href: '/admin/billing', icon: BillingIcon },
  { label: 'Audit Logs', href: '/admin/audit', icon: AuditIcon },
];
      ...
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col fixed h-full">
        ...
        <div className="px-6 py-5 border-b border-gray-100">
          <Link href="/admin" className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl text-gray-900">PrepMeet</span>
          </Link>
          <p className="text-xs text-gray-500 mt-1 ml-10">Admin Portal</p>
        </div>
